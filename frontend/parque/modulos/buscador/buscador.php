...
$oFiltro->agregarCriterio("AND Propiedades_Publicacion.idEstadoPublicacion NOT IN(".ESTADO_PUBLICACION_NO_PUBLICADO.",".ESTADO_PUBLICACION_ARCHIVADO.") ");
...
//las propiedades de la inmobiliaria activa
...
if ($accion == "buscar"){
	...
	if(is_numeric($categoria)){
		$oFiltro->agregarCriterio("AND Propiedades_Publicacion.idTipoPublicacion = $categoria");
	}
