 	...
 	$(document).ready(function(){
    	$("#frmConsulta").validate({
   			submitHandler: function(form) {
						$.ajax({
							type: 'POST',
							url: './modulos/propiedades/formSubmit.php',
		...
		$("#calDisponibilidad").empty().load("./modulos/propiedades/calendar.php?p=<?php echo $propiedad; ?>").fadeIn('slow');
  	});
...
<div id="contenedor_detalle">
	...
	<div id="detalle_galeria">
		...
		foreach ($aImagenes as $oImagen){ 
			...
			class="thumbnail"
			src="modulos/propiedades/loadImage.php?idp=<?php echo($oImagen->getIdPropiedad()); ?>&id=<?php echo($oImagen->getIdImagen()); ?>&s=t"  >
	...
	<?php  if ($mostrarCalendario) { ?>
        ...
        <div style="float:left; clear:both;"><h4><?php echo "Disponibilidad:";//echo (ETIQUETA_DISPONIBILIDAD); ?></h4></div>
        <div id="calDisponibilidad">
        	<div style="padding-top:150px; text-align:center;"><img src="./imagenes/loading.gif" /><br />Cargando ...</div>
        </div>
