...
/*meta tags*/
define("META_KEYWORDS","inmobiliaria, piñera, pinera, san telmo, buenos aires, rentals, apartments, propiedades");
define("META_TITLE","Inmobiliaria De Piñera");
define("META_DESCRIPCION","Inmobiliaria De Piñera");

/*direccion a la que se envian las consultas desde la web*/
define("CONTACTO_EMAIL", "info@depinera.com.ar");

/*asunto de las consultas enviadas desde la web*/
define("CONTACTO_ASUNTO", "Consulta recibida desde la p&aacute;gina web");
...
/*ESTADOS DE PUBLICACION DE UNA PROPIEDAD*/
