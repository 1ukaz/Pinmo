...
function getDaysLeft( $fechaPasada ) {	
	$numDays = floor(abs(strtotime($fechaPasada) - strtotime(date("Y-m-d")))/86400);
...
function sacarOrden( $orden ) {
	switch( $orden ) {
		case 1:
			return "P.idPropiedad ASC, P.idProvincia, P.idLocalidad, P.calle";
		break;
		case 2:
			return "I.descripcion_inmobiliaria ASC, P.idPropiedad, P.idProvincia, P.idLocalidad, P.calle";
		break;
		case 3:
			return "P.codigoReferencia ASC, P.idPropiedad, P.idProvincia, P.idLocalidad, P.calle";
		break;
		case 4:
			return "P.idLocalidad ASC, P.calle, P.idPropiedad, I.descripcion_inmobiliaria";
		break;
		case 5:
			return "P.calle ASC, P.idLocalidad, I.descripcion_inmobiliaria, P.idPropiedad";
		break;
		case 6:
			return "ESP.idEstadoPublicacion ASC, I.descripcion_inmobiliaria, P.idPropiedad, P.idLocalidad";
		break;
		default:
			return "P.idPropiedad ASC, P.idProvincia, P.idLocalidad, P.calle";
		break;
